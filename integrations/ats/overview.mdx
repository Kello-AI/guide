...
<CardGroup cols={2}>
  <Card title="Lever ATS" icon="check-double" iconType="regular" href="/integrations/ats/lever">
    The intergration is **live **and actively being used by multiple organisations
  </Card>
  <Card title="Greenhouse ATS" icon="check" href="/integrations/ats/greenhouse">
